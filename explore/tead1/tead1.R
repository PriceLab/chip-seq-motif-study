...
dbListTables(db) # "gtf"         "motifsgenes" "chipseq"

tf <- "TEAD1"
chrom <- "chr19"

#------------------------------------------------
# just 3 TEAD1 ChIP-seq hits in this 14.4k region
#------------------------------------------------
start.loc <- 44902547
end.loc   <- 44917011

#------------------------------------------------
# 2030 TEAD1 ChIP-seq hits in this 58.6M region
#------------------------------------------------
start.loc <- 1
end.loc <- 58617616
...
fimo.pValScores.withFailures <- c(fimo.pValScores, rep(0, chips.unmatched))
